...
$day6 = $today->sub(new DateInterval('P1D'))->format('Y-m-d');
$day5 = $today->sub(new DateInterval('P1D'))->format('Y-m-d');
$day4 = $today->sub(new DateInterval('P1D'))->format('Y-m-d');
$day3 = $today->sub(new DateInterval('P1D'))->format('Y-m-d');
$day2 = $today->sub(new DateInterval('P1D'))->format('Y-m-d');
$day1 = $today->sub(new DateInterval('P1D'))->format('Y-m-d');
...
$sql_week = "SELECT * FROM history WHERE id_user='$id_user' AND date >= '%$day1%' ORDER BY date DESC";
